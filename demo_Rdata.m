...
%% load real data
% Leukemia 
%X = csvread('Real_dataset/Leukemia.csv'); A = X(2:7129,:)';  y = X(1,:)';
% TDT2
%load('Real_dataset/TDT2.mat'), A = fea(1:500,:); y = gnd(1:500); 
%20NewsHome,Reuters21578  
%load('Real_dataset/20NewsHome.mat'), A = fea;  y = gnd;
%srbct, prostate  
A = csvread('Real_dataset/prostate_x.csv',1,1);  y = csvread('Real_dataset/prostate_y.csv');
